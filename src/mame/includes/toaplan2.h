...
public:
	...
	DECLARE_WRITE16_MEMBER(tekipaki_hd647180_cpu_w); /* THUNDERMAME HACKS */
	...
	UINT32 screen_update_toaplan2s(screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect);

...
ROM_START( ketstoic )
	ROM_REGION( 0x600000, "maincpu", 0 ) /* 68000 Code */
	/* doesn't use a separate BIOS rom */
	ROM_LOAD16_WORD_SWAP( "ketsui_vstc.u38", 0x000000, 0x200000, CRC(35c984e4) SHA1(d4517f318de0c40a3b30e41374f33bb355581434) )
...
GAME( 2014, ketarr,       ket,       pgm_arm_type1_cave,    pgm, pgm_arm_type1_state,     ket,       ROT270, "hack (trap15)", "Ketsui: Kizuna Jigoku Tachi (2014/07/16 ARRANGE 1.7 VER) (hack)", GAME_IMPERFECT_SOUND | GAME_SUPPORTS_SAVE )
...
GAME( 2012, ketstoic,     ket,       pgm_arm_type1_cave,    pgm, pgm_arm_type1_state,     ket,       ROT270, "hack by trap15", "Ketsui: Mr.Stoic (2012/09/27 MR.STOIC VER.)", GAME_IMPERFECT_SOUND | GAME_SUPPORTS_SAVE )
